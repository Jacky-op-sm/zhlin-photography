...
export default function TravelCardSlider({
  ...
  const cardHeightRem = variant === 'spot' && isMobile ? CARD_HEIGHT_REM : CARD_HEIGHT_REM * CARD_HEIGHT_MULTIPLIER;
          ...
          {cards.map((card, index) => {
            ...
            return (
              <button
                ...
                aria-label={`${openCardAriaLabelPrefix} ${cardId}`}
              >
...
function CardContent({ card, variant }: { card: TravelSliderCard; variant: TravelCardSliderVariant }) {
